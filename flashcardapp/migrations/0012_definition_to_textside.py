...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for flashcard in orm.Flashcard.objects.all():
            definitionLabel = orm.Label.objects.get(name="Definition")
            definition = flashcard.definition
            orm.TextSide.objects.create(text=definition, flashcardKey=flashcard, labelKey=definitionLabel)
            flashcard.defaultSideLabel = definitionLabel
            flashcard.save()
    ...
    def backwards(self, orm):
        ...
        for flashcard in orm.Flashcard.objects.all():
            definitionLabel = orm.Label.objects.get(name="Definition")
            definitionSide = flashcard.textside_set.get(labelKey=definitionLabel)
            flashcard.definition = definitionSide.text
            flashcard.save()
            definitionSide.delete()
