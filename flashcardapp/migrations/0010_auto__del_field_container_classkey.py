...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Container.classkey'
        db.delete_column('flashcardapp_container', 'classkey_id')


    def backwards(self, orm):
        # Adding field 'Container.classkey'
        db.add_column('flashcardapp_container', 'classkey',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='Old key', null=True, to=orm['flashcardapp.Class']),
                      keep_default=False)
