...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field containers on 'Tag'
        db.create_table('flashcardapp_tag_containers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tag', models.ForeignKey(orm['flashcardapp.tag'], null=False)),
            ('container', models.ForeignKey(orm['flashcardapp.container'], null=False))
        ))
        db.create_unique('flashcardapp_tag_containers', ['tag_id', 'container_id'])


    def backwards(self, orm):
        # Removing M2M table for field containers on 'Tag'
        db.delete_table('flashcardapp_tag_containers')
