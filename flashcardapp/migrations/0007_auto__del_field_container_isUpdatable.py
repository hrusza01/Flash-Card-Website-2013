...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Container.isUpdatable'
        db.delete_column('flashcardapp_container', 'isUpdatable')


    def backwards(self, orm):
        # Adding field 'Container.isUpdatable'
        db.add_column('flashcardapp_container', 'isUpdatable',
