...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field classes on 'Container'
        db.create_table('flashcardapp_container_classes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('container', models.ForeignKey(orm['flashcardapp.container'], null=False)),
            ('class', models.ForeignKey(orm['flashcardapp.class'], null=False))
        ))
        db.create_unique('flashcardapp_container_classes', ['container_id', 'class_id'])


    def backwards(self, orm):
        # Removing M2M table for field classes on 'Container'
        db.delete_table('flashcardapp_container_classes')
    ...
    models = {
        ...
        'flashcardapp.container': {
            ...
            'classkey': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'Old key'", 'null': 'True', 'to': "orm['flashcardapp.Class']"}),
