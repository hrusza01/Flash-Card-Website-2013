...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flashcard.defaultSideLabel'
        db.add_column('flashcardapp_flashcard', 'defaultSideLabel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flashcardapp.Label'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Flashcard.defaultSideLabel'
        db.delete_column('flashcardapp_flashcard', 'defaultSideLabel_id')
