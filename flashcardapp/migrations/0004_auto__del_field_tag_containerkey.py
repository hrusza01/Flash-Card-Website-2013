...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tag.containerkey'
        db.delete_column('flashcardapp_tag', 'containerkey_id')


    def backwards(self, orm):
        # Adding field 'Tag.containerkey'
        db.add_column('flashcardapp_tag', 'containerkey',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='oldcontainer', null=True, to=orm['flashcardapp.Container']),
                      keep_default=False)
